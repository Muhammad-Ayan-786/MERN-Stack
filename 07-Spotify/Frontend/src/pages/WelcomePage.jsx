...
const WelcomePage = () => {
  return (
    <section className="w-screen min-h-screen bg-[url(https://static.vecteezy.com/system/resources/previews/028/215/268/non_2x/wavy-lines-with-lighting-background-vector.jpg)] bg-no-repeat bg-cover bg-center flex justify-center items-center text-white backdrop-blur-2xs">
      ...
      {/* Main Container */}
      <div className="flex flex-col justify-between items-center gap-8 w-9/12 h-1/2 py-5 px-3 rounded-3xl bg-green-950 shadow-2xl shadow-lime-200 md:p-10 md:gap-0 md:flex-row">
        ...
        <div className="w-2/5 h-full flex flex-col gap-8 justify-center items-start">
          ...
          <div className="flex flex-col gap-5 w-full">
            <Link to='/api/auth/register' className="md:w-full bg-lime-500 rounded-full text-center py-2 px-4 md:py-3.5 md:px-8 text-base font-bold text-gray-50 text-shadow-lime-950 text-shadow-lg md:text-lg">Sign up</Link>
            <Link to='/api/auth/login' className="md:w-full bg-lime-500 rounded-full text-center py-2 px-4 md:py-3.5 md:px-8 text-base font-bold text-gray-50 text-shadow-lime-950 text-shadow-lg md:text-lg">Log in</Link>
          </div>
        </div>
      </div>
