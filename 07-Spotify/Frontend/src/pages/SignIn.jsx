  ...
  return (
    <section className='w-screen h-screen flex justify-center items-center bg-gray-950 text-white'>
      ...
      <div className="container bg-gray-900 w-2/3 h-4/5 flex flex-col gap-5 justify-between rounded-xl p-5 shadow-2xl shadow-green-500/40 sm:w-1/2 md:w-2/5">
        ...
        {/* Hero Title */}
        <h1 className="text-4xl font-bold text-center text-green-500 text-shadow-sm text-shadow-gray-400 hidden lg:block">Spotify Registration</h1>
        <h1 className="text-3xl font-bold text-center text-green-500 text-shadow-sm text-shadow-gray-400 block lg:hidden">Sign-in</h1>
        ...
        <form className=" flex-1 flex flex-col justify-between" onSubmit={formSubmit}>
          ...
          {/* Email Input */}
          <div className="flex flex-col gap-2">
            <label htmlFor="email" className="sm:text-lg text-gray-300 text-shadow-green-400 text-shadow-xs">Email</label>
            <div className="flex gap-2 relative">
              <AtSign className="absolute top-2.5 left-2 text-green-500 text-shadow-xs" size={20} />
              <input
                className="text-base bg-gray-700 w-full outline-none py-2 px-5 pl-10 rounded  focus:ring-1 focus:ring-green-500 focus:ring-offset-1 focus:ring-offset-gray-900"
                required
                type="email"
        ...
        <p className="text-base">
          Already have an account? <Link to='http://localhost:5173/api/auth/login' className="font-bold text-base cursor-pointer text-green-400 text-shadow-gray-300 text-shadow-xs transition-all hover:text-green-600">
            Log in
          </Link>
        </p>
